...
//   var amountInput = document.querySelector(".data").innerText;
//   var upiId = "nawabfaisal0@oksbi"; // Replace with your UPI ID

//   var upiLink = "upi://" + upiId + "?amount=" + amountInput;

//   // Create a new QRious instance and pass the UPI link as the value
//   var qr = new QRious({
//     element: document.getElementById("qrcode-canvas"),
//     value: upiLink,
//     size: 80, // Adjust the size of the QR code (width and height in pixels)
//   });
// }

// document.getElementById("generateQR").addEventListener("click", generateQRCode);
function formatAmount(amount) {
  // Remove commas and format the amount to two decimal places
  return parseFloat(amount.replace(/,/g, "")).toFixed(2);
}
function generatePaymentIntentURL(upiId, amount) {
...
function generateQRCode() {
  var amountInput = document.querySelector(".data").innerText;
  var upiId = "7782812577@okbizaxis"; // Replace with your UPI ID

  var upiLink = generatePaymentIntentURL(upiId, amountInput);
